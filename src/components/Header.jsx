...
const Header = () => {
  ...
  return (
    <div
      className={` fixed -translate-x-1/2 top-0 left-1/2 w-full z-50  border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${
    ...
    >
      ...
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a href="#hero" className="block w-[12rem] xl:mr-8">
          {/* <img src={ER} width={190} height={40} alt="Brainwave" /> */}
          <svg
            width="100px"
            height="50px"

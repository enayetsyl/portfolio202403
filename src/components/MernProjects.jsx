  ...
  return (
    <Section id="how-to-use" crosses>
      <div className="container">
        <Heading
          title="MERN Reflections: Grateful Steps in Web Development."
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-1/2 h-full pointer-events-none  xl:w-1/2 opacity-70">
              <img
                src={meetready}
                alt="meetready"
                width={800}
                height={730}
                className="w-full h-full md:object-scale-down lg:m-0 lg:p-0 -ml-3 mt-[1px]
                lg:object-fill
                "
              />
            </div>
            <div className="relative z-1 max-w-[17rem] ml-auto backdrop-filter backdrop-blur-xl bg-opacity-10 rounded-lg p-10 bg-blue-300">
              <h4 className="h4 mb-4">Meet Ready</h4>
